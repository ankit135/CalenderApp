...
class DTCalendarDayView: UIView {
    ...
    private var beginImage = UIImage.init(named: "cal_front")
    private var endImage = UIImage.init(named: "cal_end")
    private var selectedImage = UIImage.init(named: "cal_selected")
    ...
    override func layoutSubviews() {
        ...
        bgImage.frame = CGRect(x: 0, y: 0, width: width, height: height)
